...
<body >
   ...
   <section id ="recDiv" class="text-center">
      <div class="col-md-12">
         <div class="portfolio_title">
            <h1>추천</h1>
            <br>
            <p style="font-size: 20px;">주요 관광지를 추천해드립니다 &#128154; 사람이 많은 곳에서 플로깅 활동을 진행해봅시다 &#128539;</p>
         	<br>
         </div>
      </div>
   ...
   <form id="nsdiSearchForm" action="#" class="validation-form" onsubmit="return false;search();">
      <select id="sido_code" class="btn btn-success dropdown-toggle" name="sido_code">
         <option>시/도 선택</option>
      </select>
      
      <!--   <button type="button" class="btn btn-success">Success</button>style=" height:30px; background-color:#198754 ; border-color:black;"
      -->
      <select id="sigoon_code"  class="btn btn-success dropdown-toggle" name="sigoon_code">
         <option>군/구 선택</option>
      </select> 
      <!-- <input type="submit" id="gettour" value="제출"></input> -->
     
      <button type="submit" id="gettour"  class="btn btn-outline-success" style=" height:30px; background-color:white; color:black; border-color:black;" >찾기</button>
   </form>
   <!-- form 태그 end -->
  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <input type="hidden" name="user_id" value="${sessionScope.userVO.id}"/>
         <div class="form-group-kind" style="font-weight:bold;">
         ...
         <div class="form-group">
            <b>선택한 장소를 담으시겠습니까? </b>
            <p><br></p>
            <button type="submit" class="btn btn-default"  style="background-color:#198754; ">담기</button>
